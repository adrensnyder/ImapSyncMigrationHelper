...
For all the scripts i'm using **Powershell 5.1 Build 22621 Rev. 2506**.
EDIT: After update to Graph i've tested App creation and some other scripts on **Powershell 7.5.0** and seems working correctly
